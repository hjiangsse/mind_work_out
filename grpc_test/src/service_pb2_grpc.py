...
class DACServicer(object):
    ...
    def CreateFactor(self, request, context):
        """创建因子
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
    ...
    def ModifyFactor(self, request, context):
        """改level、改信息等
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
    ...
    def ListFactor(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_DACServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreateFactor': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateFactor,
                    request_deserializer=service__pb2.FactorRequest.FromString,
                    response_serializer=service__pb2.FcAclResult.SerializeToString,
            ),
            'ModifyFactor': grpc.unary_unary_rpc_method_handler(
                    servicer.ModifyFactor,
                    request_deserializer=service__pb2.FactorRequest.FromString,
                    response_serializer=service__pb2.CommonResult.SerializeToString,
            ),
            ...
            'ListFactor': grpc.unary_unary_rpc_method_handler(
                    servicer.ListFactor,
                    request_deserializer=service__pb2.LoginInfo.FromString,
...
class DAC(object):
    ...
    def CreateFactor(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/jgproto.DAC/CreateFactor',
    ...
    def ModifyFactor(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/jgproto.DAC/ModifyFactor',
            service__pb2.FactorRequest.SerializeToString,
            service__pb2.CommonResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteFactor(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/jgproto.DAC/DeleteFactor',
            service__pb2.FactorRequest.SerializeToString,
            service__pb2.FcAclResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ListFactor(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/jgproto.DAC/ListFactor',
            service__pb2.LoginInfo.SerializeToString,
    ...
    def GetFactor(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/jgproto.DAC/GetFactor',
            service__pb2.FactorRequest.SerializeToString,
